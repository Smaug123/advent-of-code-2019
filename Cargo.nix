...
args @ {
  ...
  nixifiedLockHash = "2c62079535a1c0939e19c82a8a522acda584ca27c505613a01d397dd4c5ab20f";
  workspaceSrc =
...
in
  ...
  in {
    ...
    workspace = {
      ...
      day_9 = rustPackages.unknown.day_9."0.1.0";
      day_10 = rustPackages.unknown.day_10."0.1.0";
      day_11 = rustPackages.unknown.day_11."0.1.0";
      day_13 = rustPackages.unknown.day_13."0.1.0";
      day_16 = rustPackages.unknown.day_16."0.1.0";
      day_19 = rustPackages.unknown.day_19."0.1.0";
    };
    ...
    "unknown".day_10."0.1.0" = overridableMkRustCrate (profileName: rec {
      name = "day_10";
      version = "0.1.0";
      registry = "unknown";
      src = fetchCrateLocal workspaceSrc;
      features = builtins.concatLists [
        (lib.optional (rootFeatures' ? "day_10/no_real_inputs") "no_real_inputs")
      ];
      devDependencies = {
        criterion = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".criterion."0.4.0" {inherit profileName;}).out;
      };
    ...
    "unknown".day_11."0.1.0" = overridableMkRustCrate (profileName: rec {
      name = "day_11";
      version = "0.1.0";
      registry = "unknown";
      src = fetchCrateLocal workspaceSrc;
      features = builtins.concatLists [
        (lib.optional (rootFeatures' ? "day_11/no_real_inputs") "no_real_inputs")
      ];
      dependencies = {
      ...
      devDependencies = {
        criterion = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".criterion."0.4.0" {inherit profileName;}).out;
        insta = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".insta."1.42.0" {inherit profileName;}).out;
      };
    });

    "unknown".day_13."0.1.0" = overridableMkRustCrate (profileName: rec {
      name = "day_13";
      version = "0.1.0";
      registry = "unknown";
      src = fetchCrateLocal workspaceSrc;
      features = builtins.concatLists [
        (lib.optional (rootFeatures' ? "day_13/no_real_inputs") "no_real_inputs")
      ];
      dependencies = {
        intcode = (rustPackages."unknown".intcode."0.1.0" {inherit profileName;}).out;
      };
    ...
    "unknown".day_16."0.1.0" = overridableMkRustCrate (profileName: rec {
      name = "day_16";
      version = "0.1.0";
      registry = "unknown";
      src = fetchCrateLocal workspaceSrc;
      features = builtins.concatLists [
        (lib.optional (rootFeatures' ? "day_16/no_real_inputs") "no_real_inputs")
      ];
      devDependencies = {
        criterion = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".criterion."0.4.0" {inherit profileName;}).out;
      };
    ...
    "unknown".day_19."0.1.0" = overridableMkRustCrate (profileName: rec {
      name = "day_19";
      version = "0.1.0";
      registry = "unknown";
      src = fetchCrateLocal workspaceSrc;
      features = builtins.concatLists [
        (lib.optional (rootFeatures' ? "day_19/no_real_inputs") "no_real_inputs")
      ];
      dependencies = {
        intcode = (rustPackages."unknown".intcode."0.1.0" {inherit profileName;}).out;
      };
    ...
    "unknown".day_9."0.1.0" = overridableMkRustCrate (profileName: rec {
      name = "day_9";
      version = "0.1.0";
      registry = "unknown";
      src = fetchCrateLocal workspaceSrc;
      features = builtins.concatLists [
        (lib.optional (rootFeatures' ? "day_9/no_real_inputs") "no_real_inputs")
      ];
      dependencies = {
        intcode = (rustPackages."unknown".intcode."0.1.0" {inherit profileName;}).out;
      };
    ...
    "registry+https://github.com/rust-lang/crates.io-index".insta."1.42.0" = overridableMkRustCrate (profileName: rec {
      name = "insta";
      version = "1.42.0";
      registry = "registry+https://github.com/rust-lang/crates.io-index";
      src = fetchCratesIo {
        inherit name version;
        sha256 = "6513e4067e16e69ed1db5ab56048ed65db32d10ba5fc1217f5393f8f17d8b5a5";
      };
      features = builtins.concatLists [
        ["colors"]
        ["console"]
